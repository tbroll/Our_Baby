  ...
  <body>
   <?php include 'nav.html';?>
    <header class="subpage">
      <div>
        <h1>Faculty &amp; Staff</h1>
         <h3>at Computer Science Department</h3>
      </div>
    </header>
              ...
              <div class="col-sm-6 col-md-4">
                  <div class="thumbnail">
                      ...
                      <div class="caption">
                          <h3>Mary Lange</h3>
                          <p>
                          Email: <a href="mailto:mlange@winona.edu?Subject=Hello" target="_top">mlange@winona.edu</a>
                          </p>
                      </div>
                  </div>
              </div>
              <div class="col-sm-6 col-md-4">
                  <div class="thumbnail">
                      ...
                      <div class="caption">
                          ...
                          <p>
                          Email: <a href="mailto:smcdonnell@winona.edu?Subject=Hello" target="_top">smcdonnell@winona.edu</a>
                          </p>
